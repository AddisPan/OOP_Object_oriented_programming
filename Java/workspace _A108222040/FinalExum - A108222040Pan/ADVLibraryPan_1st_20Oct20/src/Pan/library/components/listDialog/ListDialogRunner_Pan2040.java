 ...
 */
public class ListDialogRunner_Pan2040 {
    static JFrame frame;
...
//        });
        ...
        panel = createNsetupBtnNPanel(intro, name, button, "Pick your choice:", null);
...
//
    ...
    public static JPanel createUI(String _title4lb, String _aimTitle, String[] _names, ImageIcon icon) {
    	names = _names;
    	JLabel intro = new JLabel(_title4lb);
    	final JLabel name = new JLabel(names[1]);
    	intro.setLabelFor(name);
    	...
    	JButton button = new JButton(_aimTitle, icon);
    	
    	panel = createNsetupBtnNPanel(intro, name, button, _aimTitle, icon);
    	return panel;
    }
    
    public static JPanel createNsetupBtnNPanel(JLabel intro, JLabel name, JButton _button, String _aimTitle, Icon icon)
    {
    	//Create butotn
    	final JButton button = _button;
    	button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
						   selectedName = ListDialog_Pan2040.showDialog(
								              frame, 
								              button, 
								              _aimTitle, 
								              "Name Chooser", 
     ...
     */
    private static void createAndShowGUI(String _titile4Frame) { //modified
        //Create and set up the window.
        frame = new JFrame(_titile4Frame);
    ...
    public static void createAndShowGUI(JFrame frame, String _titile4Frame, String _title4lb, String _aimTitle, String[] _names, ImageIcon icon) {
    	//Create and set up the window
    	frame = new JFrame(_titile4Frame);// modified
    	frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    	
    	//Create and set up the content pane
    	
    	JComponent newContentPane = createUI(_title4lb, _aimTitle, _names, icon);
    ...
    public static void main(String[] args) {
    	String titile4Frame = "Name That Baby";
        //Schedule a job for the event-dispatching thread:
        //creating and showing this application's GUI.
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                createAndShowGUI(titile4Frame);
            }
        });
    }
}
