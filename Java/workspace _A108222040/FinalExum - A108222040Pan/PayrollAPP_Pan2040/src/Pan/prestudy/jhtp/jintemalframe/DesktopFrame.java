package Pan.prestudy.jhtp.jintemalframe;
...
public class DesktopFrame extends JFrame 
{
   ...
   public DesktopFrame()
   {
      ...
      JMenuItem newFrame1 = new JMenuItem("Internal Frame");
      JMenuItem newFrame2 = new JMenuItem("Internal Frame2");

      addMenu.add(newFrame1); // add new frame item to Add menu
...
class MyJPanel extends JPanel 
{
   ...
   private static final String[] images = {"./complex_images/lavenderflowers.png", 
      "./complex_images/purpleflowers.png", "./complex_images/redflowers.png", "./complex_images/redflowers2.png", 
      "./complex_images/yellowflowers.png"};
