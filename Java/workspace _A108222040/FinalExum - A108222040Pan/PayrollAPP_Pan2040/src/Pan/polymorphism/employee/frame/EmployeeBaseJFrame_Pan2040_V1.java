...
public class EmployeeBaseJFrame_Pan2040_V1 extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EmployeeBaseJFrame_Pan2040_V1 frame = new EmployeeBaseJFrame_Pan2040_V1(employeeType);
	 ...
	 * Create the frame.
	 */
	public EmployeeBaseJFrame_Pan2040_V1(String employeeType) {
