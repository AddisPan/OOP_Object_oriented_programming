...
public class CommissionEmployee_V1 extends Employee {
   private double grossSales; // gross weekly sales
   private double commissionRate; // commission percentage

   // constructor
   public CommissionEmployee_V1(String _firstName, String _lastName, String _socialSecurityNumber,boolean _isSimpleFormat
   ...
   public String toString3() {                                  
	   return String.format("\r\n%10s, %s, %,15.2f, %15.2f, %15.2f",
   		    "C-Employee", super.toString3(),getGrossSales(), getCommissionRate());              
	   } 
} 