...
public class BasePlusCommissionEmployee_V1 extends CommissionEmployee {
   private double baseSalary; // base salary per week


   // constructor
   public BasePlusCommissionEmployee_V1(String _firstName, String _lastName, 
   ...
   public String toString2() {                                          
	      return String.format("%s %s; %s: $%,.2f", super.toString(),"base salary", getBaseSalary());                              
	   }        
