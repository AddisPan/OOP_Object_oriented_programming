...
public class CommissionEmployeeJFrame_Pan2040_V2 extends EmployeeBaseJFrame_Pan2040_V1{
	...
	public  CommissionEmployeeJFrame_Pan2040_V2(String employeeType)
	{
		super(employeeType);
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CommissionEmployeeJFrame_Pan2040_V2 frame = new CommissionEmployeeJFrame_Pan2040_V2(employeeType);
