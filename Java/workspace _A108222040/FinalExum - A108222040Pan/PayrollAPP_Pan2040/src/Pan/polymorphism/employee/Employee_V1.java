...
public abstract class Employee_V1 implements Serializable {
	...
	// constructor
	public Employee_V1(String _firstName, String _lastName, String _socialSecurityNumber, boolean _isSimpleFormat) {
	...
	public void setColor(Color _indexColor) {
