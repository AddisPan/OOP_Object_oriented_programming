...
public class EmployeeBaseJFrame_Pan2040 extends JFrame {
	...
	public static void main(String[] args) {
		employeeType = "SuperBase Emplyee (by Mei-Chun Lo)";
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EmployeeBaseJFrame_Pan2040 frame = new EmployeeBaseJFrame_Pan2040(employeeType);
	 ...
	 * Create the frame.
	 */
	public EmployeeBaseJFrame_Pan2040(String employeeType) {
